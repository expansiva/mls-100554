/// <mls shortName="collabMessagesThreadModal" project="100554" enhancement="_100554_enhancementLit" />
...
@customElement('collab-messages-thread-modal-100554')
export class CollabMessagesThreadModal100554 extends StateLitElement {
    ...
    private handleGlobalMouseMove = (e: MouseEvent) => {
        const modal = this.querySelector('collab-messages-thread-modal-100554');
    ...
    render() {
        ...
        >
            ...
            <collab-messages-avatar-100554 avatar=${this.thread?.avatar_url} alt=${this.thread?.name} ></collab-messages-avatar-100554>
                <div>
