/// <mls fileReference="_100554_/l2/pluginProjectUsage.ts" groupName="other" enhancement="_100554_enhancementLit" />
...
if (!customElements.get('plugin-project-usage-100554')) {
    customElements.define('plugin-project-usage-100554', PluginProjectUsage);
}
