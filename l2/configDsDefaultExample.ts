...
export class Example extends mls.l3.Example {
    ...
    public list: mls.l3.IComponentsExampleInfos = {};
    ...
    private _find(componentName: string, exampleName: string): mls.l3.IComponentsExample | null {
        const key = this.getKeyComponentExample(componentName, exampleName);
        return this.list[key];
    }

    private async _addComponentExample(componentName: string, exampleName: string, description: string, exampleJsonP: string, reference?: mls.l3.IDSRef): Promise<void> {
        ...
        const newExample: mls.l3.IComponentsExample = {
            exampleName,
            description,
    ...
    private _addComponentExample2(component: mls.l3.IComponentInfo, example: mls.l3.IComponentsExample) {
    ...
    private async _getExampleEl(example: mls.l3.IComponentsExample): Promise<HTMLElement> {
    ...
    private async _getJsonPExampleIO(example: mls.l3.IComponentsExample, componentName: string): Promise<string> {
    ...
    private async _setJsonPExampleIO(example: mls.l3.IComponentsExample, componentName: string, content: string | null): Promise<boolean> {
