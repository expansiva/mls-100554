...
export class CollabTiles extends LitElement {
    ...
    @property({ type: [], reflect: true }) tilesItens = [    
        {
            title: 'Disciplina',
            plugin: '<img src="https://static.escolakids.uol.com.br/2023/01/grafico-colunas.jpg" style="width:100%; height:100%"></img>',
            position: '1 / 1 / 4 / 4'
        },
        
        {
            title: 'Acidentes',
            plugin: '<img src="https://www.professorguru.com.br/images/grafico-com-3-linhas.png" style="width:100%; height:100%"></img>',
            position: '1 / 4 / 3 / 7'
        },
        {
            title: 'Atividades',
            plugin: '<img src="https://static.escolakids.uol.com.br/2023/01/grafico-setores.jpg" style="width:100%; height:100%"></img>',
            position: '3 / 4 / 7 / 7'
        },
        {
            title: 'Numero',
            plugin: '<img src="https://buzzmonitor.com.br/wp-content/uploads/from-pyro-cms/bccffb224c2d17da70732f7f9a9489d9.jpg" style="width:100%; height:100%"></img>',
            position: '4 / 1 / 7 / 4'
        }
    ];
    ...
    renderItem(item: ITilesItem) {
        return html`
        <collab-tiles-item-100554 position="${item.position}" plugin="${item.plugin}"></collab-tiles-item-100554>
        `
    }
    ...
    renderConfigItensOpen() {
        return html`
            <div style="display:flex; justify-content: end;">
                <button style="margin-right:10px" title="config" @click="${this.open}">
    ...
    renderConfigItensClose() {
        return html`
            <div style="display:flex; justify-content: end;">
                <button style="margin-right:10px" title="config" @click="${this.close}">
