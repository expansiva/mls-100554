/// <mls fileReference="_100554_/l2/pluginProjectRunTest.defs.ts" enhancement="_blank" />

// Do not change – automatically generated code. 

export const asis: mls.defs.AsIs = {
  "meta": {
    "fileReference": "_100554_/l2/pluginProjectRunTest.ts",
  ...
  "references": {
    "webComponents": [
      ...
      "plugin-project-run-test-100554"
    ],
    "imports": [
      {
        "ref": "lit",
