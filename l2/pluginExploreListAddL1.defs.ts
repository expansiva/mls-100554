/// <mls fileReference="_100554_/l2/pluginExploreListAddL1.defs.ts" enhancement="_blank" />

// Do not change – automatically generated code. 

export const asis: mls.defs.AsIs = {
  "meta": {
    "fileReference": "_100554_/l2/pluginExploreListAddL1.ts",
  ...
  "references": {
    "webComponents": [
      "plugin-explore-list-add-l1-100554"
    ],
    "imports": [
      {
        "ref": "lit",
