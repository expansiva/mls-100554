/// <mls fileReference="_100554_/l2/designSystem.ts"  enhancement="_blank" />
 ...
 * (MANDATORY_COLOR_ROLES / DEFAULT_TOKENS_TEMPLATE). See TASK-100554-ds-tokens-por-papel.md.
 *
 * Naming rules (color):
 ...
 *  - surface-alt-bg takes bg-secondary-color-LIGHTER in light (#F9F9F9, the
 *    zebra/section grey of 23 rules) but _dark-bg-secondary-color in dark
 *    (#161b22): the old dark twin of the lighter family was #636363, a mid grey
 *    that cannot serve as a surface over a #0d1117 page.
 ...
 *  - border-default is grey-color-dark (the 20 "1px solid" rules) and
 *    border-subtle is grey-color; the -hover/-focus/-disabled steps are derived
 *    (the old grey scale had no states).
 *  - button-primary-bg is active-color (#1890FF): active-color painted the
 *    buttons (8 background rules) AND the selection (18 color rules), so it also
 *    feeds selected-text, selected-border and focus-ring. info-color kept only
 *    its state reading (status-info-text).
