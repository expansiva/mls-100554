/// <mls shortName="agentNewModule3" project="100554" enhancement="_100554_enhancementLit" groupName="other" />

import { IAgent, svg_agent } from './_100554_aiAgentBase';
import { getPromptByHtml } from './_100554_aiPrompts';
import { getPayload2, PayLoad2 } from './_100554_agentNewModule2';
import {
...
export interface PayLoad3 {
    ...
    organism: Organism[],
    flatPersistentData: FlatPersistentData[],
    hierarchicalPersistentData: HierarchicalPersistentData[],
    entityOrganismMap: EntityOrganismMap[]
}
...
export interface Organism {
    ...
    organismTag: string;
    organismDataNeeds: string[];
    organismPlugins: string[];
    planning: {
        context: string;
        goal: string;
...
export interface FlatPersistentData {
    prima: string[];
}
export interface HierarchicalPersistentData {
    entitySequential: number;
    entityName: string;
    entityDefinitions: string[];
}
export interface EntityOrganismMap {
    entityName: string;
    organisms: string[];
}
