...
export class SimpleGreeting extends LitElement {
    ...
    render() {
        ...
        return html`
            <input type="text" id="idteste" autocomplete="off"></input>
            <wc-aux-command-100554 idElView="idteste" caracter="/" .itens=${this.listComands} @clickitem=${this.clickItem}/>
        `;
