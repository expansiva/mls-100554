/// <mls fileReference="_100554_/l2/pluginTaskInfo.ts" enhancement="_102027_/l2/enhancementLit" />
...
import '/_100554_/l2/pluginTaskPreview.js';
import '/_100554_/l2/pluginTaskLogPreview.js';

@customElement('plugin-task-info-100554')
export class PluginTaskInfo extends StateLitElement {
    ...
    renderRaw() {
        return html`<plugin-task-details-100554 .task=${this.task} .message=${this.message} taskId=${this.task?.PK}></plugin-task-details-100554>`
    }
