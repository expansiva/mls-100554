...
export class agentPlannerNewWidget extends AgentBase implements IAgentBase {
...
`
            },
            {
                type: 'system',
                content: `
## Restrição para definição do componente Base e icaDescription

Com base nos requisitos passados pelo usuário, o icaDescription deve retornar um dos tipos definidos em icaDescriptions. Segue abaixo:

const icaDescriptions: IIcaDescriptions = {
...
`
            },
            {
                type: 'system',
                content: `
## Obrigatoriedade para os atributos
...
`
            },
            {
                type: 'system',
                content: `
## Restrição para widgetName

Não atribuir os seguintes nomes para o campo widgetName:
...
`
            },
            {
                type: 'system',
                content: `
## Definições dos atributos do componente
