/// <mls fileReference="_100554_/l2/pluginViewFile.ts" enhancement="_100554_/l2/enhancementLit" />
...
if (!customElements.get('plugin-view-file-100554')) {
    customElements.define('plugin-view-file-100554', PluginViewFile);
}
