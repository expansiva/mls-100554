...
import { WCDOverlayMethods, WCDToolboxMethodos } from '/_100554_/l2/wcdTypes.js';
...
export class WcdOverlayModeDefaultItem extends WcdOverlayItemLitBase {
    ...
    public fcCallBackClick = this.onCBClick;
