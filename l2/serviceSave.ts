...
const message_pt = {
    ...
    noItemsToSave: 'Conecte no "gitHub", faça SignIn no "gitHub" para permitir salvar nos repositórios<br/>É importante salvar nos repositórios para permitir históricos e evitar perca de dados.',
...
const message_en = {
    ...
    noItemsToSave: 'Connect to "gitHub", SignIn to "gitHub" to allow saving to repositories<br/>It is important to save to repositories to allow history and avoid data loss.',
