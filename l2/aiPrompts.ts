...
async function getListFilesStart(start: 'tool' | 'agent'): Promise<string[]> {
        ...
        content: `##COMPONENTES DISPONÍVEIS
{
    ...
    "ica-forms-input-number": {
        ...
        widgetDefault:"wc-input-number-100554",
    ...
    "ica-forms-input-string": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["**ica-forms-content-form"],
        widgetDefault:"wc-input-text-100554",
    ...
    "ica-forms-input-date": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["**ica-forms-content-form"],
        widgetDefault:"wc-input-date-100554",
    ...
    "ica-forms-input-select-one": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["**ica-forms-content-form"],
        widgetDefault:"wc-select-one-100554",
    ...
    "ica-forms-input-color": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["**ica-forms-content-form"],
        widgetDefault:"wc-input-color-100554",
    ...
    "ica-forms-submit-submit": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["**ica-forms-content-form"],
        widgetDefault:"wc-button-submit-100554",
    ...
    "ica-navigation-content-accordion": {
        ...
        allowedChildren: ["!*"],
        allowedParents: ["ica-navigation-content-nav"],
        widgetDefault:"wc-accordion-details-100554",
    ...
    "ica-layout-flow-section": {
        ...
        allowedParents: [],
        widgetDefault:"wc-section-100554",
    ...
    "ica-layout-flow-column": {
        ...
        widgetDefault:"wc-column-100554",
    ...
    "ica-layout-flow-divider": {
        ...
        allowedChildren: [],
        allowedParents: ["ica-layout-flow-section"],
        widgetDefault:"wc-divider-line-100554",
    ...
    "ica-layout-group-table": {
        ...
        allowedChildren: [],
        allowedParents: ["ica-layout-flow-section"],
        widgetDefault:"wc-table-select-100554",
