/// <mls fileReference="_100554_/l2/pluginNavigationRenderOrganism.ts" groupName="other" enhancement="_100554_enhancementLit" />
...
export class PluginNavigationRenderOrganism extends PluginBaseModule {
    ...
    private openCollabMessage(item: IInfoElChildren) {
